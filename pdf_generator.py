    ...
    for chunk in chunks:
        ...
        def flush_list():
            ...
            if current_list_items:
                lf = ListFlowable(
                    [
                        ListItem(Paragraph(li, styles["Normal"]))
        ...
        for element in chunk.elements:
            ...
            if etype == "paragraph":
                ...
                t = Table(
                    wrapped_data,
                    colWidths=[(doc.width / len(wrapped_data[0]))]
                    * len(wrapped_data[0]),
                )
                t.setStyle(
                    TableStyle(
                ...
                if list_items:
                    bullet_type = (
                        "1"
                        if (element.list_style or "bullet") != "bullet"
                        else "bullet"
                    )
                    lf = ListFlowable(
                        [
                ...
                try:
                    ...
                    story.append(
                        Paragraph(
                            f"[Figure: Unable to render image - {str(e)}]",
                            styles["Caption"],
                        )
                    )
